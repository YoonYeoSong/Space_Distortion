...
public class MainRoomView extends SpaceActionEvent implements ViewIndex{
	...
	{	
		...
		lbTime2.setBounds(170, 82, 105, 49);
		jp.add(lbTime2);
		...
		lbTime3.setBounds(300, 82, 105, 49);
		jp.add(lbTime3);
		...
		lbTime4.setBounds(410, 82, 105, 49);
		jp.add(lbTime4);
		...
		lbTime5.setBounds(50, 250, 105, 49);
		jp.add(lbTime5);
		...
		lbTime6.setBounds(180, 250, 105, 49);
		jp.add(lbTime6);
		...
		lbTime7.setBounds(290, 250, 105, 49);
		jp.add(lbTime7);
		...
		lbTime8.setBounds(400, 250, 105, 49);
		jp.add(lbTime8);
